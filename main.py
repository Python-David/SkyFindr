...
last_seen = retrieve_last_seen_id(file_name="last_seen_id.txt")
...
for mention in reversed(mentions):
    ...
    if tweet_text == "Keyword #skyfind not detected, try again.":
        api.update_status(f"@{username} Please try again, make sure the #skyfind hashtag is in your tweet. See pinned "
