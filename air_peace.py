...
class AirPeace:
    ...
    def get_today_flight_details(self, origin, destination):
        try:
            ...
            # wait.until(EC.visibility_of_element_located(By.XPATH('//div[@class="panel-heading flt-panel-heading "]')))
            ...
            print("Sorry, cannot return flight details for this destination.")
